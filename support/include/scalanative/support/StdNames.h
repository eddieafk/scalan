...
struct StdNames final {
  ...
  inline static constexpr std::string_view ConstValueTuple = "constValueTuple";
  inline static constexpr std::string_view ScalaCompiletimeConstValueTuple =
  ...
  inline static constexpr std::string_view ScalaPolyFunction = "scala.PolyFunction";
  inline static constexpr std::string_view TupleApply = "apply";
  inline static constexpr std::string_view TupleConcat = "++";
  inline static constexpr std::string_view TupleHead = "head";
  inline static constexpr std::string_view TupleInit = "init";
  inline static constexpr std::string_view TupleLast = "last";
  inline static constexpr std::string_view TupleMap = "map";
  ...
  inline static constexpr std::string_view RequireConst = "requireConst";
  inline static constexpr std::string_view ScalaCompiletimeRequireConst =
  ...
  inline static constexpr std::string_view JavaNioBufferUnderflowException =
  ...
  inline static constexpr std::string_view ByteBufferGet = "get";
  inline static constexpr std::string_view ByteBufferPut = "put";
  inline static constexpr std::string_view ByteBufferGetShort = "getShort";
  ...
  inline static constexpr std::string_view RuntimeByteBufferGetShort =
      "scala.scalanative.runtime.byteBufferGetShort";
  inline static constexpr std::string_view RuntimeByteBufferPutShort =
      "scala.scalanative.runtime.byteBufferPutShort";
  inline static constexpr std::string_view RuntimeByteBufferGetShortAt =
      "scala.scalanative.runtime.byteBufferGetShortAt";
  inline static constexpr std::string_view RuntimeByteBufferPutShortAt =
      "scala.scalanative.runtime.byteBufferPutShortAt";
  inline static constexpr std::string_view RuntimeByteBufferGetInt =
      "scala.scalanative.runtime.byteBufferGetInt";
  inline static constexpr std::string_view RuntimeByteBufferPutInt =
      "scala.scalanative.runtime.byteBufferPutInt";
  inline static constexpr std::string_view RuntimeByteBufferGetIntAt =
  ...
  inline static constexpr std::string_view RuntimeByteBufferGetFloat =
      "scala.scalanative.runtime.byteBufferGetFloat";
  inline static constexpr std::string_view RuntimeByteBufferPutFloat =
      "scala.scalanative.runtime.byteBufferPutFloat";
  inline static constexpr std::string_view RuntimeByteBufferGetFloatAt =
  ...
  inline static constexpr std::string_view RuntimeByteBufferGetDoubleAt =
      "scala.scalanative.runtime.byteBufferGetDoubleAt";
  inline static constexpr std::string_view RuntimeByteBufferPutDoubleAt =
      "scala.scalanative.runtime.byteBufferPutDoubleAt";
