...
int main() {
  if (std::getenv("CPP_SCALANATIVE_SMOKE_TESTS20_ONLY") != nullptr) {
    return runSmokeTests20();
  }
  if (std::getenv("CPP_SCALANATIVE_SMOKE_TESTS19_ONLY") != nullptr) {
    return runSmokeTests19();
  }
  if (std::getenv("CPP_SCALANATIVE_SMOKE_TESTS18_ONLY") != nullptr) {
    return runSmokeTests18();
  }
  if (std::getenv("CPP_SCALANATIVE_SMOKE_TESTS17_ONLY") != nullptr) {
    return runSmokeTests17();
  }
  if (std::getenv("CPP_SCALANATIVE_SMOKE_TESTS16_ONLY") != nullptr) {
    return runSmokeTests16();
  }
  if (std::getenv("CPP_SCALANATIVE_SMOKE_TESTS15_ONLY") != nullptr) {
    return runSmokeTests15();
  }
  if (std::getenv("CPP_SCALANATIVE_SMOKE_TESTS14_ONLY") != nullptr) {
    return runSmokeTests14();
  }
  if (std::getenv("CPP_SCALANATIVE_SMOKE_TESTS13_ONLY") != nullptr) {
    return runSmokeTests13();
  }
  if (std::getenv("CPP_SCALANATIVE_SMOKE_TESTS12_ONLY") != nullptr) {
    return runSmokeTests12();
  }
  if (std::getenv("CPP_SCALANATIVE_SMOKE_TESTS11_ONLY") != nullptr) {
    return runSmokeTests11();
  }
  if (std::getenv("CPP_SCALANATIVE_SMOKE_TESTS10_ONLY") != nullptr) {
  ...
  if (std::getenv("CPP_SCALANATIVE_SMOKE_TESTS7_ONLY") != nullptr) {
    return runSmokeTests7();
  }
  if (std::getenv("CPP_SCALANATIVE_SMOKE_TESTS6_ONLY") != nullptr) {
    return runSmokeTests6();
  }
  if (std::getenv("CPP_SCALANATIVE_SMOKE_TESTS5_ONLY") != nullptr) {
    return runSmokeTests5();
  }
  if (std::getenv("CPP_SCALANATIVE_SMOKE_TESTS4_ONLY") != nullptr) {
