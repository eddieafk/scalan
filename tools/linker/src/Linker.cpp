...
bool isRuntimeBufferUnderflowOperation(std::string_view name) {
  return name == support::StdNames::RuntimeByteBufferGet ||
         ...
         name == support::StdNames::RuntimeByteBufferGetFloat ||
         name == support::StdNames::RuntimeByteBufferGetDouble;
}
...
bool isRuntimeIndexOutOfBoundsOperation(std::string_view name) {
  return name == support::StdNames::RuntimeByteBufferGetAt ||
         ...
         name == support::StdNames::RuntimeByteBufferGetFloatAt ||
         name == support::StdNames::RuntimeByteBufferPutFloatAt ||
         name == support::StdNames::RuntimeByteBufferGetDoubleAt ||
