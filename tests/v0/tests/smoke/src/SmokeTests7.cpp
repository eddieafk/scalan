...
object Main {
  ...
  const std::filesystem::path binary =
      temporary / "scalanative-smoke-compiletime-const-value-opt";
  const std::filesystem::path output =
      temporary / "scalanative-smoke-compiletime-const-value-opt.out";
...
object Main {
  ...
  const std::filesystem::path temporary = std::filesystem::temp_directory_path();
  const std::filesystem::path binary =
      temporary / "scalanative-smoke-compiletime-const-value-tuple";
  const std::filesystem::path output =
      temporary / "scalanative-smoke-compiletime-const-value-tuple.out";
  std::error_code ignored;
  std::filesystem::remove(binary, ignored);
  std::filesystem::remove(output, ignored);
