...
object Main {
  ...
  const std::filesystem::path binary =
      temporary / "scalanative-smoke-compiletime-summon-all";
  const std::filesystem::path output =
      temporary / "scalanative-smoke-compiletime-summon-all.out";
...
object Main {
  ...
  const std::filesystem::path temporary = std::filesystem::temp_directory_path();
  const std::filesystem::path binary = temporary / "scalanative-smoke-tuple-values";
  const std::filesystem::path output =
      temporary / "scalanative-smoke-tuple-values.out";
  std::error_code ignored;
  std::filesystem::remove(binary, ignored);
  std::filesystem::remove(output, ignored);
