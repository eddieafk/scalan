...
# unions with visible-join widening (including user-declared transparent
# classes/traits), and members projected from intersection constituents or a
# union's shared base-type join.
build/debug/cpp-driver/cpp-scalanative --build-binary --optimize \
